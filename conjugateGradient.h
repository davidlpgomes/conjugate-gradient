...
*/
double calculateAlphaJacobi(SparseLinearSystem* restrict sls, double* restrict r, double* restrict p, double* restrict z);
...
*/
double calculateBetaJacobi(
    SparseLinearSystem* restrict sls,
    double* restrict r,
    double* restrict r1,
    double* restrict z,
    double* restrict z1
